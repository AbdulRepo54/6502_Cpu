...
{
	// the disassembler will want to read the data at an address without changing the state of the
	// devices on the bus
...
// program. This is impemented by the "RTI" instruction. Once the IRQ
...
//The next 3 address modes use indirection 

// Address Mode: Indirect
// The supplied 16-bit address is read to get the actual 16-bit address. This is
// instruction is unusual in that it has a bug in the hardware. If the low byte of the
